        ...
        <div className="bg-[#161821] border border-white/[0.08] rounded-2xl shadow-2xl shadow-black/40 p-5">
          <div className="flex items-start justify-between mb-3">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-tempo-800/15 flex items-center justify-center">
                <Smartphone size={20} className="text-tempo-400" />
              </div>
              <div>
          ...
          <div className="space-y-3 mb-4">
            <div className="flex items-center gap-3 text-xs text-white/50">
              <div className="w-6 h-6 rounded-full bg-white/[0.06] flex items-center justify-center text-[10px] font-semibold text-tempo-400 shrink-0">1</div>
              <span>Tap the <Share size={13} className="inline text-blue-400 mx-0.5" /> Share button in Safari</span>
            </div>
            <div className="flex items-center gap-3 text-xs text-white/50">
              <div className="w-6 h-6 rounded-full bg-white/[0.06] flex items-center justify-center text-[10px] font-semibold text-tempo-400 shrink-0">2</div>
            ...
            <div className="flex items-center gap-3 text-xs text-white/50">
              <div className="w-6 h-6 rounded-full bg-white/[0.06] flex items-center justify-center text-[10px] font-semibold text-tempo-400 shrink-0">3</div>
    ...
    <div className="fixed bottom-20 left-4 right-4 z-[200] lg:left-auto lg:right-6 lg:bottom-6 lg:w-[360px] animate-in slide-in-from-bottom-4 duration-500">
      <div className="bg-[#161821] border border-white/[0.08] rounded-2xl shadow-2xl shadow-black/40 p-5">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-tempo-800/15 flex items-center justify-center">
              <svg viewBox="0 0 80 100" fill="none" className="w-5 h-6">
                ...
                <path d="M4,96 C14,90 28,76 44,56 C58,38 70,20 78,10" stroke="var(--color-tempo-600)" strokeWidth="12" strokeLinecap="round" opacity="1"/>
              </svg>
            </div>
            <div>
              <p className="text-sm font-semibold text-white">Install Tempo</p>
        ...
        <div className="flex gap-2 text-xs text-white/30 mb-4">
          ...
          <span className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-white/[0.04]">
            <span className="w-1.5 h-1.5 rounded-full bg-tempo-700/60" />
            Fast
          </span>
        </div>
        ...
        <div className="flex gap-2">
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 bg-tempo-800 text-white text-sm font-medium rounded-lg hover:bg-tempo-900 transition-colors"
          >
            <Download size={15} />
            Install App
          </button>

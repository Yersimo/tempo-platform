...
const TYPE_COLORS: Record<string, string> = {
  ...
  payroll: 'bg-tempo-700/15 text-tempo-400',
}
          ...
          {expanded && (
            <div className="mt-3 pt-3 border-t border-white/[0.06] animate-in slide-in-from-top-2 duration-200">
              ...
              <textarea
                ...
                className="w-full bg-white/[0.04] border border-white/[0.06] rounded-xl p-3 text-xs text-white/70 placeholder:text-white/20 resize-none focus:outline-none focus:border-tempo-700/30 min-h-[44px]"
                rows={2}
              />
            </div>
          )}

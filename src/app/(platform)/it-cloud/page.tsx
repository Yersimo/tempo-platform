...
function platformIcon(platform: string) {
  switch (platform) {
    ...
    case 'linux': return <Server size={14} className="text-tempo-400" />
          ...
          <>
            ...
            <div className="space-y-3">
              {encryptionPolicies.map(policy => {
                ...
                const platformBg = { macos: 'bg-gray-500/10', windows: 'bg-blue-500/10', linux: 'bg-tempo-700/10', all: 'bg-purple-500/10' }[policy.platform]
                return (
                  <Card key={policy.id} className="bg-card border-border p-4">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-3">
                        <div className={cn('w-10 h-10 rounded-lg flex items-center justify-center', platformBg)}>
                          {policy.platform === 'macos' ? <Laptop size={20} className="text-t2" /> :
                           ...
                           policy.platform === 'linux' ? <Server size={20} className="text-tempo-400" /> :

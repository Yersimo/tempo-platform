...
const TRIGGER_TYPES = [
  ...
  { value: 'expense_submitted', label: 'Expense Submitted', icon: FileText, color: 'text-tempo-400' },
...
const NODE_PALETTE = [
  ...
  { type: 'approval', label: 'Approval', icon: Shield, bgColor: 'bg-tempo-700/20', borderColor: 'border-tempo-700/40', textColor: 'text-tempo-400', shape: 'rect' },

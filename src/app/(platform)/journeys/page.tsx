          ...
          <Card className="lg:col-span-2">
            ...
            <div className="p-4">
              <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                ...
                <div className="text-center p-4 rounded-lg bg-tempo-50 dark:bg-tempo-950/20">
                  <p className="text-2xl font-bold text-tempo-800 dark:text-tempo-300">{active.length}</p>
                  ...
                  {overdueItems.slice(0, 10).map((item, idx) => (
                    <div key={`${item.journeyId}-${idx}`} className="flex items-center justify-between gap-3 p-2 rounded-lg bg-white dark:bg-gray-900/50 border border-red-100 dark:border-red-900/30">
                      ...
                      <div className="flex gap-1 shrink-0">
                        ...
                        <Button size="sm" variant="ghost" className="h-7 text-xs gap-1 text-tempo-700 dark:text-tempo-400" onClick={() => {

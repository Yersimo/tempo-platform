      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-3">
          ...
          <Card className="text-center">
            ...
            <p className="text-lg font-bold text-tempo-700">{formatCurrency(agingBuckets.days90, defaultCurrency)}</p>
          </Card>
          <Card className="text-center">
        ...
        {totalAR > 0 && (
          <div className="mt-2">
            <div className="flex h-3 rounded-full overflow-hidden bg-canvas">
              ...
              {agingBuckets.days90 > 0 && <div className="bg-tempo-700" style={{ width: `${(agingBuckets.days90 / totalAR) * 100}%` }} />}

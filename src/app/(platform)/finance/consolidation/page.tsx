                ...
                <Card>
                  ...
                  <div className="px-4 pb-4">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
                      ...
                      <div className="text-center p-3 rounded-lg bg-tempo-50 dark:bg-tempo-900/20">
                        <div className="text-xs text-t3 mb-1">OpEx</div>
                        <div className="text-sm font-semibold text-tempo-700">{formatCurrency(consolidatedData.totals.operatingExpenses, consolidatedData.consolidationCurrency)}</div>
                      </div>

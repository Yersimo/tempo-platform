      ...
      <div className="px-5 pt-5 space-y-6">
        ...
        <div className="rounded-2xl bg-[#1a1d27] border border-white/[0.04] p-5">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              {profile?.level && (
                <span className="inline-block text-[10px] bg-tempo-700/10 text-tempo-400 px-2 py-0.5 rounded-full mt-1 font-medium">
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            ...
            <a href="/time-attendance" className="text-xs text-tempo-400 flex items-center gap-1 min-h-[44px]">
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            ...
            <a href="/payroll" className="text-xs text-tempo-400 flex items-center gap-1 min-h-[44px]">
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            ...
            <a href="/performance" className="text-xs text-tempo-400 flex items-center gap-1 min-h-[44px]">
              View All <ChevronRight size={14} />
            </a>
          </div>
          {myGoals.length > 0 ? (
                ...
                <div key={goal.id} className="p-3 rounded-xl bg-[#1a1d27] border border-white/[0.04]">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="flex-1 bg-white/[0.04] rounded-full h-1.5 overflow-hidden">
                      <div
                        className="h-full bg-tempo-700 rounded-full transition-all"
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            ...
            <a href="/learning" className="text-xs text-tempo-400 flex items-center gap-1 min-h-[44px]">

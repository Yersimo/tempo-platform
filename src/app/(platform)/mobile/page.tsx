        ...
        <div className="flex items-center justify-between pt-4">
          ...
          <div className="flex items-center gap-2">
            ...
            {pushPermission === 'granted' && (
              <div className="relative p-2.5 rounded-xl bg-tempo-700/10 text-tempo-400 min-h-[44px] min-w-[44px] flex items-center justify-center">
                <Bell size={18} />
          ...
          <div className="space-y-6 animate-in fade-in duration-300">
            ...
            <div>
              ...
              <div className="grid grid-cols-4 gap-2">
                {[
                  { icon: CheckSquare, label: 'Approvals', color: 'text-tempo-400', bg: 'bg-tempo-700/10', badge: pendingApprovals.length, tab: 'approvals' as TabId },
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <button
                    ...
                    className="text-xs text-tempo-400 flex items-center gap-1 min-h-[44px]"
                  >

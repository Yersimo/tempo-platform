...
const MIGRATION_SOURCES = [
  ...
  { id: 'rippling', name: 'Rippling', icon: <Layers size={20} />, description: 'Import employees, departments, and payroll data', color: 'bg-tempo-50 border-tempo-200' },
  ...
  { id: 'sap', name: 'SAP SuccessFactors', icon: <Building2 size={20} />, description: 'Import from SAP SuccessFactors HR', color: 'bg-tempo-50 border-tempo-200' },
]

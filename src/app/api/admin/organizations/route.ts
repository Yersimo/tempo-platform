    ...
    <div style="padding:32px">
      ...
      <div style="background:#f9fafb;border:1px solid #eee;border-radius:8px;padding:20px;margin-bottom:20px">
        ...
        <table style="width:100%;font-size:13px;color:#555">
          <tr><td style="padding:4px 0;font-weight:500;width:120px">Login URL</td><td><a href="https://theworktempo.com/login" style="color:#285B7A">https://theworktempo.com/login</a></td></tr>
      ...
      <a href="https://theworktempo.com/login" style="display:inline-block;padding:12px 28px;background:#285B7A;color:#fff;text-decoration:none;border-radius:8px;font-size:14px;font-weight:600">Sign In to Tempo</a>
    </div>

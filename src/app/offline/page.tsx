  ...
  return (
    <div className="min-h-screen bg-[#0f1117] flex flex-col items-center justify-center p-6 text-center">
      ...
      <svg viewBox="0 0 80 100" fill="none" className="w-10 h-12 mb-8 opacity-40">
        <line x1="2" y1="3" x2="78" y2="3" stroke="var(--color-tempo-600)" strokeWidth="4" strokeLinecap="round" opacity=".18"/>
      ...
      <div className={`w-20 h-20 rounded-full border flex items-center justify-center mb-6 ${
        ...
        {isOnline ? (
          ...
          <WifiOff size={36} className="text-tempo-600/60" />
        )}
      </div>
      ...
      <div className="flex gap-3 mb-8">
        <button
          ...
          className="flex items-center gap-2 px-5 py-2.5 bg-tempo-800 text-white text-sm font-medium rounded-lg hover:bg-tempo-900 transition-colors min-h-[44px]"
        >
          <RefreshCw size={15} />
          Try Again
        </button>
          ...
          <div className="flex items-center justify-between mb-3">
            ...
            {isOnline && (
              <button
                onClick={triggerSync}
                disabled={isSyncing}
                className="text-xs text-tempo-600 flex items-center gap-1 min-h-[44px] disabled:opacity-50"
              >

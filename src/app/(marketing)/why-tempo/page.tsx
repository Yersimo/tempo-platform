              ...
              <tr>
                {comparisonHeaders.map((h, i) => (
                  <th key={h} style={{
                    ...
                    background: i === 1 ? 'var(--color-tempo-50)' : 'transparent',
                  }}>{h}</th>
                ))}
              </tr>
            </thead>
                ...
                <tr key={row.feature}>
                  ...
                  {row.values.map((val, i) => (
                    <td key={i} style={{
                      ...
                      background: i === 0 ? 'var(--color-tempo-50)' : 'transparent',
                    }}>
                      {getCellText(val)}
                    </td>
                  ))}
          ...
          {reasons.map((r, i) => (
            <div key={r.title} style={{ display: 'grid', gridTemplateColumns: '48px 1fr', gap: 20, alignItems: 'start' }}>
              <div style={{
                ...
                fontSize: 20, fontWeight: 700, color: 'var(--color-tempo-500)', flexShrink: 0,
              }}>{i + 1}</div>
              <div>

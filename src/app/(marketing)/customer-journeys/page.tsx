            ...
            <div key={j.title} style={{ background: 'var(--white)', border: '1px solid var(--border)', borderRadius: 18, padding: 32 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 16 }}>
                <div style={{
                  ...
                  background: 'var(--color-tempo-50)',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  fontSize: 16, fontWeight: 700, color: 'var(--color-tempo-600)', flexShrink: 0,
                }}>{idx + 1}</div>
                <div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                    ...
                    {j.badge && (
                      <span style={{
                        fontSize: 11, fontWeight: 600, color: 'var(--color-tempo-600)',
                        background: 'var(--color-tempo-50)', padding: '3px 10px',
                  ...
                  <div key={si} style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', flexShrink: 0 }}>
                      <div style={{
                        ...
                        background: 'var(--color-tempo-50)', border: '1px solid rgba(40,91,122,0.15)',
                        display: 'flex', alignItems: 'center', justifyContent: 'center',
                        fontSize: 11, fontWeight: 600, color: 'var(--color-tempo-600)',
                      }}>{si + 1}</div>
                      {si < j.steps.length - 1 && (

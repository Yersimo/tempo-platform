    ...
    <div className="min-h-screen bg-[#fafafa]">
      ...
      <div style={{ maxWidth: 640, margin: '60px auto', padding: '0 24px' }}>
        ...
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: 6, padding: '4px 12px', borderRadius: 20, background: 'rgba(234,88,12,.06)', border: '1px solid rgba(234,88,12,.15)', marginBottom: 20 }}>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="var(--color-tempo-600)" strokeWidth="2" strokeLinecap="round"><rect x="3" y="3" width="18" height="18" rx="2" /><path d="M9 3v18M3 9h18" /></svg>
          <span style={{ fontSize: 12, fontWeight: 600, color: 'var(--color-tempo-600)' }}>Enterprise</span>
        </div>
        ...
        <p style={{ fontSize: 14, color: '#999', marginBottom: 32 }}>
          ...
          <a href="mailto:enterprise@theworktempo.com" style={{ color: 'var(--color-tempo-600)', textDecoration: 'none', fontWeight: 500 }}>
        ...
        {submitted ? (
          <div style={{ background: '#fff', borderRadius: 16, border: '1px solid #e5e7eb', padding: 40, textAlign: 'center' }}>
            ...
            <Link href="/" style={{ display: 'inline-block', marginTop: 20, fontSize: 14, fontWeight: 600, color: 'var(--color-tempo-600)', textDecoration: 'none' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
              <div>
                <label style={{ fontSize: 13, fontWeight: 600, color: '#333', display: 'block', marginBottom: 6 }}>
                  Name <span style={{ color: 'var(--color-tempo-600)' }}>*</span>
                </label>
                <input
                  type="text"
                  required
              ...
              <div>
                <label style={{ fontSize: 13, fontWeight: 600, color: '#333', display: 'block', marginBottom: 6 }}>
                  Email <span style={{ color: 'var(--color-tempo-600)' }}>*</span>
                </label>
                <input
                  type="email"
                  required
              ...
              <div>
                <label style={{ fontSize: 13, fontWeight: 600, color: '#333', display: 'block', marginBottom: 6 }}>
                  Company <span style={{ color: 'var(--color-tempo-600)' }}>*</span>
                </label>
                <input
                  type="text"
                  required
              ...
              <div>
                <label style={{ fontSize: 13, fontWeight: 600, color: '#333', display: 'block', marginBottom: 6 }}>
                  Message <span style={{ color: 'var(--color-tempo-600)' }}>*</span>
                </label>
                <textarea
                  required
        ...
        <div style={{ textAlign: 'center', marginTop: 32 }}>
          <p style={{ fontSize: 13, color: '#999' }}>
            Not an enterprise?{' '}
            <Link href="/demo-request" style={{ color: 'var(--color-tempo-600)', textDecoration: 'none', fontWeight: 500 }}>
              Request a demo
            </Link>{' '}
            or{' '}
            <Link href="/signup" style={{ color: 'var(--color-tempo-600)', textDecoration: 'none', fontWeight: 500 }}>
              start a free trial
            </Link>
          </p>
        </div>

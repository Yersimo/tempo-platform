      ...
      <div className="min-h-screen bg-white antialiased flex items-center justify-center">
        ...
        <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-2xl border-b border-black/[0.04]">
          <div className="max-w-[1200px] mx-auto px-6 flex items-center justify-between h-[64px]">
            <Link href="/academy" className="text-[22px] font-bold tracking-[-0.02em] text-[#1a1a1a]">tempo<span className="text-tempo-500">.</span></Link>
          </div>
        </nav>
        ...
        <div className="flex-1 flex items-start justify-center py-12 sm:py-16 px-6">
          <div className="w-full max-w-[480px]">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              {/* Interest */}
              <div>
                <label className="block text-[13px] font-medium text-[#1a1a1a]/70 mb-1.5">I&rsquo;m interested in... <span className="text-tempo-500">*</span></label>
                <select
                  value={form.interest}
                  onChange={e => update('interest', e.target.value)}
                  className="w-full h-12 px-4 rounded-xl border border-black/10 bg-white text-[15px] text-[#1a1a1a] focus:outline-none focus:border-tempo-500 focus:ring-1 focus:ring-tempo-500/20 transition appearance-none"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-[13px] font-medium text-[#1a1a1a]/70 mb-1.5">First name <span className="text-tempo-500">*</span></label>
                  <input type="text" value={form.firstName} onChange={e => update('firstName', e.target.value)} placeholder="First name" className="w-full h-12 px-4 rounded-xl border border-black/10 text-[15px] text-[#1a1a1a] placeholder:text-black/25 focus:outline-none focus:border-tempo-500 focus:ring-1 focus:ring-tempo-500/20 transition" />
                </div>
                <div>
                  <label className="block text-[13px] font-medium text-[#1a1a1a]/70 mb-1.5">Last name <span className="text-tempo-500">*</span></label>
                  <input type="text" value={form.lastName} onChange={e => update('lastName', e.target.value)} placeholder="Last name" className="w-full h-12 px-4 rounded-xl border border-black/10 text-[15px] text-[#1a1a1a] placeholder:text-black/25 focus:outline-none focus:border-tempo-500 focus:ring-1 focus:ring-tempo-500/20 transition" />
                </div>
              </div>

              {/* Company */}
              <div>
                <label className="block text-[13px] font-medium text-[#1a1a1a]/70 mb-1.5">Company / Organisation <span className="text-tempo-500">*</span></label>
              ...
              {/* Email */}
              <div>
                <label className="block text-[13px] font-medium text-[#1a1a1a]/70 mb-1.5">Work email <span className="text-tempo-500">*</span></label>
                <input type="email" value={form.email} onChange={e => update('email', e.target.value)} placeholder="you@company.com" className="w-full h-12 px-4 rounded-xl border border-black/10 text-[15px] text-[#1a1a1a] placeholder:text-black/25 focus:outline-none focus:border-tempo-500 focus:ring-1 focus:ring-tempo-500/20 transition" />
              </div>

              {/* Phone */}
              <div>
                <label className="block text-[13px] font-medium text-[#1a1a1a]/70 mb-1.5">Phone number</label>
                <input type="tel" value={form.phone} onChange={e => update('phone', e.target.value)} placeholder="+234 800 000 0000" className="w-full h-12 px-4 rounded-xl border border-black/10 text-[15px] text-[#1a1a1a] placeholder:text-black/25 focus:outline-none focus:border-tempo-500 focus:ring-1 focus:ring-tempo-500/20 transition" />
              </div>
              ...
              <label className="flex items-start gap-3 cursor-pointer group">
                <input type="checkbox" checked={form.agreed} onChange={e => update('agreed', e.target.checked)} className="mt-1 w-4 h-4 rounded border-black/20 text-tempo-500 focus:ring-tempo-500/30" />
                <span className="text-[13px] text-[#1a1a1a]/50 leading-[1.5]">
                  Yes, I agree to Tempo&rsquo;s <Link href="/privacy" className="underline hover:text-[#1a1a1a] transition">privacy policy</Link>. We&rsquo;ll use your information to respond to your enquiry and share relevant updates. <span className="text-tempo-500">*</span>
                </span>
              </label>

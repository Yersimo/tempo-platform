    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-3 gap-3">
        <Card className="text-center !p-4">
          <Flame size={20} className="mx-auto text-tempo-700 mb-1" />
      ...
      <Card>
        <div className="flex items-center gap-3 mb-3">
          <div className="w-9 h-9 rounded-xl bg-tempo-50 flex items-center justify-center shrink-0">
            <Flame size={18} className="text-tempo-700" />
          </div>
          <div>
          ...
          {Array.from({ length: 14 }).map((_, i) => (
            <div
              ...
              className={cn(
                ...
                i < streakDays ? 'bg-tempo-400' : i < 10 ? 'bg-tempo-200' : 'bg-gray-100',
              )}
              title={`Day ${i + 1}`}
            />
          ))}

...
const btn = 'display:inline-block;padding:12px 28px;background:#285B7A;color:#fff;text-decoration:none;border-radius:8px;font-size:14px;font-weight:600'
  ...
  return {
    ...
    html: wrapTemplate(`
      <div style="padding:32px">
        ...
        <div style="background:#EEF5FA;border-left:4px solid #285B7A;padding:12px 16px;border-radius:0 8px 8px 0;margin-bottom:20px">

...
<body style="font-family:-apple-system,sans-serif;background:#f5f5f7;margin:0;padding:40px 20px">
  <div style="max-width:560px;margin:0 auto;background:#fff;border-radius:12px;overflow:hidden">
    ...
    <div style="padding:32px">
      ...
      ${link ? `<a href="${link}" style="display:inline-block;padding:10px 24px;background:#285B7A;color:#fff;text-decoration:none;border-radius:8px;font-size:14px;font-weight:500">View in Tempo</a>` : ''}
    </div>

...
<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:20px">
  ...
  <button class="no-print" onclick="window.print()" style="padding:8px 16px;background:#285B7A;color:#fff;border:none;border-radius:6px;cursor:pointer;font-size:12px">Print / Save as PDF</button>
</div>
<table>

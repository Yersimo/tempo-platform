...
- Identity & Access, Password Manager, Benefits, Time & Attendance, and Global Workforce now also include workforce/security trust panels for access posture, credential governance, benefits coverage, workforce time, and international operations without changing access, credentials, elections, timesheets, payroll inputs, worker records, or filings.
- Recruiting, Headcount, Compensation, Vendors, and Procurement now also include hiring/planning/supplier trust panels for hiring decisions, workforce plans, rewards decisions, supplier control, and procure-to-pay evidence without changing candidates, positions, compensation, supplier records, POs, receipts, matches, or payments.
- Analytics, Strategy, Workflows, Budgets, and Global Spend now also include decision/automation/treasury trust panels for source coverage, OKR coherence, automation reliability, budget governance, and global treasury evidence without changing reports, objectives, automations, budgets, FX transfers, balances, or payments.
- Revenue Recognition, Entity Consolidation, Transfer Pricing, Engagement, Mentoring, and Projects now also include revenue/tax/growth/execution trust panels for revenue evidence, consolidation close, tax defense, employee voice, growth matching, and project execution without changing recognition entries, consolidation reports, tax reports, surveys, mentoring pairs, tasks, projects, or automations.
- Expense report submission now includes a policy outcome preview before submit, showing policy-ready vs needs-review status, report total, matched policy count, receipt readiness, high-value item count, route explanation, and the top policy warnings without changing approval, reimbursement, payment, or persistence behavior.
